#ifndef BARREL_READER_H
#define BARREL_READER_H
...
class BarrelReader
{
	...
	typedef std::map<std::string, std::tuple<CORNER_MAP, CORNER_MAP, bool>> BARREL_MAP;
	BARREL_MAP marks;
...
public:
	...
	AlignTransform GetNominalTransformToWorld(int const&, int const&);
